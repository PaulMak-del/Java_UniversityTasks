...
public class SortingAndFind
{
    ...
    public static Student find(Student[] list, String student) throws StudentNotFoundException
    {
        for(Student studentIn : list)
        {
            if (studentIn.getName().equals(student))
                return studentIn;
        }
